...
\textit{[Architecture diagram: Browser / PWA $\leftrightarrow$\\
Express\,+\,Socket.io $\leftrightarrow$
PostgreSQL\,/\,Redis\,/\,Google APIs\,/\,WhatsApp]}
\vspace{1.5cm}}}
...
GDPR erasure) and Redis (for sub-second fan-out).
...
The location update pipeline operates in four stages:
\begin{enumerate}
